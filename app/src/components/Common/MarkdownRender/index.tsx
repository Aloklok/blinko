...
const MermaidWrapper = React.lazy(() => import('./MermaidWrapper'));
const MarkmapWrapper = React.lazy(() => import('./MarkmapWrapper'));
const EchartsWrapper = React.lazy(() => import('./EchartsWrapper'));
        ...
        <ReactMarkdown
          ...
          components={{
            ...
            code: ({ node, className, children, ...props }) => {
              ...
              if (language === 'mermaid') {
                return (
                  <React.Suspense fallback={<Skeleton className="w-full h-80 rounded-lg" />}>
                    <MermaidWrapper content={String(children || '')} />
                  </React.Suspense>
                );
              }
              ...
              if (language === 'mindmap') {
                return (
                  <React.Suspense fallback={<Skeleton className="w-full h-80 rounded-lg" />}>
                    <MarkmapWrapper content={String(children || '')} />
                  </React.Suspense>
                );
              }
              ...
              if (language === 'echarts') {
                return (
                  <React.Suspense fallback={<Skeleton className="w-full h-80 rounded-lg" />}>
                    <EchartsWrapper options={String(children || '').trim()} />
                  </React.Suspense>
                );
              }
